...
let dottedY = [];
let xDots = [];
let colors = ['#EEAAAA', '#EEC5AA', '#EEE0AA', '#C5EEAA', '#AAEEC5', '#AAEEE0', '#AAE0EE', '#AAAAEE']; //#EEAAAA to #AAAAEE
function setup() {
  canvas = createCanvas((gridScalar+(gridScalar-DIAM)) * (LENGTH+1), (gridScalar+(gridScalar-DIAM)) * (LENGTH+1));
  background(100);
